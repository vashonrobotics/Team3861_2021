...
import org.firstinspires.ftc.teamcode.drive.ProgrammerDriveConstants;
...
public class TrackWidthTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        for (int i = 0; i < NUM_TRIALS; i++) {
            ...
            double trackWidth = ProgrammerDriveConstants.TRACK_WIDTH * Math.toRadians(ANGLE) / headingAccumulator;
